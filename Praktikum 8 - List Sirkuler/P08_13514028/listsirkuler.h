...
/*
	LIST INI MERUPAKAN VARIASI LIST LINIER - LIST SIRKULER

	BEBERAPA DEFINISI
	1. Elemen pertama: First(L)
	2. List kosong: First(L) bernilai Nil
	3. Elemen terakhir: Last(L) = P; Next(P) = First(L)

	
	CATATAN TEKNIS
	1. Autograder akan menangani stack overflow. Stack overflow maupun alokasi memori yang buruk akan menyebabkan execution failure. 
	   Memori Limit adalah 16Mb. Testcase dijamin tidak akan melebihi 100 elemen, sehingga memori limit yang diberikan sudah SANGAT BERLEBIH untuk kondisi tidak terjadi stackoverflow.

	LAIN-LAIN
	1. Untuk penjelasan detail skema pemrosesan list serta fungsional list sirkuler, silahkan melihat diktat/slide kuliah
