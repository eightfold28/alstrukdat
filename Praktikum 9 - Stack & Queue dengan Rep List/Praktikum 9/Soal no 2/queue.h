...
typedef struct {
	int id; //urutan kedatangan siswa di kantin “siswa ke-i”
	int nilaiMath; //M
	int lamaPelayanan; //T, persiapan makanan untuk siswa
	int waktuKedatangan; //A
	int mulaiPelayanan; //waktu persiapan makanan untuk siswa dimulai
} Infotype;
